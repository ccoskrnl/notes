...
- [滥用漏洞驱动 (BYOVD) 实现任意内核读写并绕过 PPL 保护](https://medium.com/@s12deff/abusing-a-vulnerable-driver-byovd-to-gain-arbitrary-kernel-r-w-and-bypass-ppl-protection-571552c7efc8)
...
- [BYOVD to the next level (part 2) — rootkit like it's 2025](https://blog.quarkslab.com/exploiting-lenovo-driver-cve-2025-8061_part2.html)
...
- [Windows 系统安全事件应急响应](https://xz.aliyun.com/news/2206)
